...
// 0.02 上下
const points = [ [0.22, 0], [0.22, 1], [0.24, 0], [0.24, 1], [0.26, 0], [0.26, 1], [0.28, 0], [0.28, 1], [0.3, 0], [0.3, 1], [0.32, 0], [0.32, 1], [0.34, 0], [0.34, 1], [0.36, 0], [0.36, 1], [0.38, 0], [0.38, 1], [0.4, 0], [0.4, 1], [0.42, 0], [0.42, 1], [0.44, 0], [0.44, 1], [0.46, 0], [0.46, 1], [0.48, 0], [0.48, 1], [0.5, 0], [0.5, 1], [0.52, 0], [0.52, 1], [0.54, 0], [0.54, 1], [0.56, 0], [0.56, 1], [0.58, 0], [0.58, 1], [0.6, 0], [0.6, 1], [0.62, 0], [0.62, 1], [0.64, 0], [0.64, 1], [0.66, 0], [0.66, 1], [0.68, 0], [0.68, 1], [0.7, 0], [0.7, 1], [0.72, 0], [0.72, 1], [0.74, 0], [0.74, 1], [0.76, 0], [0.76, 1], [0.78, 0], [0.78, 1], [0.8, 0], [0.8, 1]]
// 0.5  中间
...
export const iconStyle = {
  ...
  '断路器': { width: '80', height: '80', anchorPoints: [[0.5, 1], [0.5, 0]] },
  ...
  '发电机': { width: '80', height: '80', anchorPoints: [[0.5, 1] ] },
  ...
  '电动机': { width: '80', height: '80', anchorPoints: [[0.5, 0]] },
  ...
  '变压器': { width: '80', height: '80', anchorPoints: [[0.5, 0], [0.5, 1]] },
